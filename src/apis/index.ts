...
import { EspoRpcProvider } from "./espo";

export class BaseRpcProvider {
  private readonly coreProvider: Provider;
  private espoProvider?: EspoRpcProvider;
  ...
  get espo(): EspoRpcProvider {
    if (!this.espoProvider) {
      this.espoProvider = new EspoRpcProvider(this.coreProvider);
    }

    return this.espoProvider;
  }
